...
import {Link} from 'react-router-dom' //to link to single page post with all the comments.
import Moment from 'react-moment'
import {connect} from 'react-redux' //to handle actions such as add and remove likes.
